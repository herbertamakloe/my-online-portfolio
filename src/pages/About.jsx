			...
			<div className="container">
				...
				<div className="intro_section">
					<div className="intro_text">
						...
						<h1>quick intro</h1>
						<p className="intro">
							Well my full name is Herbert Kwabla Tamakloe but you can just call
							me Herbert. I hold a bachelor's degree in Computer Science and
							Technology from the Beijing University Of Technology,
							Beijing-China. While studying in China I picked up a few courses
							online on web development and this led me to pursue developing
							software that run in the browser. I love the computer so much and
							I enjoy building softwares that run on it.
						</p>
					</div>
				...
				<div className="expert_section">
					...
					<div className="expert_cards">
						...
						<div className="cards">
							...
							<div className="card_text">
								I am a passionate developer and that is why I make sure I have
